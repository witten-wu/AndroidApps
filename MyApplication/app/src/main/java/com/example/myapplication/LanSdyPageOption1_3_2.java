...
public class LanSdyPageOption1_3_2 extends Fragment {

    private static final int AUDIO_TITLE = R.raw.g1ainst_05; // 标题音频
    private static final int AUDIO_CORRECT = R.raw.g1ainst_a101; // 正确反馈音频
    private static final int AUDIO_WRONG1 = R.raw.g1ainst_a102; // 错误1反馈音频
    private static final int AUDIO_WRONG2 = R.raw.g1ainst_a103; // 错误2反馈音频
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option1_3_2, container, false);
