...
public class LanSdyPageOption1_3_3 extends Fragment {

    private static final int AUDIO_TITLE = R.raw.g1ainst_06; // 标题音频
    private static final int AUDIO_CORRECT = R.raw.g1ainst_a201; // 正确反馈音频
    private static final int AUDIO_WRONG1 = R.raw.g1ainst_a202; // 错误1反馈音频
    private static final int AUDIO_WRONG2 = R.raw.g1ainst_a203; // 错误2反馈音频

    private MediaPlayer mediaPlayer;
    private ViewPager2 viewPager;
    private ImageView image1, image2, image3, btnPlay, btnClose;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option1_3_3, container, false);
    ...
    private void setupListeners() {
        ...
        image1.setOnClickListener(v -> {
            handleImageSelection(image1, AUDIO_WRONG1, false);
        });

        // 图片2点击事件（假设是正确答案）
        image2.setOnClickListener(v -> {
            handleImageSelection(image2, AUDIO_CORRECT, true);
        });
