...
public class LanSdyPageOption1_5 extends Fragment {
    ...
    public static LanSdyPageOption1_5 newInstance(int[] images, int index, String[] itemname, int[] correctAnswer, int[] titleAudioResId) {
    ...
    private void loadNextPage() {
        if (images != null && currentIndex + 2 < images.length) {
            ...
            ((MainActivity) requireActivity()).updateLanSdyPageOption1_5(
                    images,
                    currentIndex + 2,
                    itemnames,
