...
public class LanSdyPageOption2_3_2 extends Fragment {

    private static final int AUDIO_TITLE = R.raw.g2ainst_05; // 标题音频
    private static final int AUDIO_CORRECT = R.raw.g2ainst_a101; // 正确反馈音频
    private static final int AUDIO_WRONG1 = R.raw.g2ainst_a102; // 错误1反馈音频
    private static final int AUDIO_WRONG2 = R.raw.g2ainst_a103; // 错误2反馈音频
    private static final int AUDIO_WRONG3 = R.raw.g2ainst_a104; // 错误3反馈音频
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option2_3_2, container, false);
