...
public class LanSdyPageOption2_3_3 extends Fragment {

    private static final int AUDIO_TITLE = R.raw.g2ainst_06; // 标题音频
    private static final int AUDIO_CORRECT = R.raw.g2ainst_a201; // 正确反馈音频
    private static final int AUDIO_WRONG1 = R.raw.g2ainst_a202; // 错误1反馈音频
    private static final int AUDIO_WRONG2 = R.raw.g2ainst_a203; // 错误2反馈音频
    private static final int AUDIO_WRONG3 = R.raw.g2ainst_a204; // 错误3反馈音频
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option2_3_3, container, false);
