...
public class LanSdyPageOption2_5 extends Fragment {
    ...
    public static LanSdyPageOption2_5 newInstance(int[] images, int index, String[] itemname, int[] correctAnswer, int[] titleAudioResId) {
        LanSdyPageOption2_5 fragment = new LanSdyPageOption2_5();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option2_5, container, false);
    ...
    private void setupListeners() {
        ...
        btnPlay.setOnClickListener(v -> {
            int currentGroup = currentIndex / 4;
        ...
        image3.setOnClickListener(v -> {
            if (image3.getVisibility() == View.VISIBLE) {
                ...
                boolean isCorrect = false;
                if (correctAnswers != null && currentGroup < correctAnswers.length) {
                    isCorrect = (correctAnswers[currentGroup] == 2);
                }
                handleImageSelection(image3, isCorrect ? AUDIO_CORRECT : AUDIO_WRONG, isCorrect);
            }
        });
        ...
        image4.setOnClickListener(v -> {
            if (image4.getVisibility() == View.VISIBLE) {
                ...
                boolean isCorrect = false;
                if (correctAnswers != null && currentGroup < correctAnswers.length) {
                    isCorrect = (correctAnswers[currentGroup] == 3);
                }
                handleImageSelection(image4, isCorrect ? AUDIO_CORRECT : AUDIO_WRONG, isCorrect);
            }
        });
    }
    ...
    private void loadNextPage() {
        if (images != null && currentIndex + 4 < images.length) {
            ...
            ((MainActivity) requireActivity()).updateLanSdyPageOption2_5(
                    images,
                    currentIndex + 4,
                    itemnames,
