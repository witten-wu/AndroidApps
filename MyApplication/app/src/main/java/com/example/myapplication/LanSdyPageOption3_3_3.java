...
public class LanSdyPageOption3_3_3 extends Fragment {

    private static final int AUDIO_TITLE = R.raw.g2binst_06; // 标题音频
    private static final int AUDIO_CORRECT = R.raw.g2binst_a201; // 正确反馈音频
    private static final int AUDIO_WRONG1 = R.raw.g2binst_a202; // 错误1反馈音频
    private static final int AUDIO_WRONG2 = R.raw.g2binst_a203; // 错误2反馈音频
    private static final int AUDIO_WRONG3 = R.raw.g2binst_a204; // 错误3反馈音频
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option3_3_3, container, false);
    ...
    private void setupListeners() {
        ...
        image1.setOnClickListener(v -> {
            handleImageSelection(image1, AUDIO_WRONG3, false);
        });
        ...
        image4.setOnClickListener(v -> {
            handleImageSelection(image4, AUDIO_CORRECT, true);
        });
