...
public class LanSdyPageOption3_5 extends Fragment {
    ...
    public static LanSdyPageOption3_5 newInstance(int[] images, int index, String[] itemname, int[] correctAnswer, int[] titleAudioResId) {
        LanSdyPageOption3_5 fragment = new LanSdyPageOption3_5();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option3_5, container, false);
    ...
    private void loadNextPage() {
        if (images != null && currentIndex + 4 < images.length) {
            ...
            ((MainActivity) requireActivity()).updateLanSdyPageOption3_5(
                    images,
                    currentIndex + 4,
                    itemnames,
