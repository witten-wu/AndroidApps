...
public class LanSdyPageOption4_3_3 extends Fragment {

    private static final int AUDIO_TITLE = R.raw.g2cinst_06; // 标题音频
    private static final int AUDIO_CORRECT = R.raw.g2cinst_a201; // 正确反馈音频
    private static final int AUDIO_WRONG1 = R.raw.g2cinst_a202; // 错误1反馈音频
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ls_option4_3_3, container, false);
