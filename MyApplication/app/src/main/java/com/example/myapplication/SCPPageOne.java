...
public class SCPPageOne extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.scp_page0, container, false);
    }
    ...
    private void savePartialData() {
        try {
            ...
            partialData.put("experimentType", "SentenceComprehension");
    ...
    private void saveAllTrialData() {
        try {
            ...
            experimentData.put("experimentType", "SentenceComprehension");
    ...
    private void saveToFile(String jsonData) {
        try {
            ...
            File experimentSubFolder = new File(experimentFolder, "Comprehension");
            ...
            File file = new File(experimentSubFolder, fileName);
