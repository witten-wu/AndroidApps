...
public class SFAPageSixFragment extends Fragment {
    ...
    private static final String TAG = "SFAPageSix";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.sfa_page6, container, false);
    }
    ...
    private String generateUniqueAudioPath(String subjectId) {
        ...
        if (!experimentFolder.exists()) {
            ...
            if (!created) {
                ...
                // 如果创建失败，回退到根目录
                return requireContext().getExternalFilesDir(null).getAbsolutePath() + "/" + timestamp + "_" + imageName + "_step5.3gp";
            }
        }

        // 返回完整的文件路径：deviceId/subjectId/NameScreeners/timestamp.3gp
        return experimentFolder.getAbsolutePath() + "/" + timestamp + "_" + imageName + "_step5.3gp";
    }
